...
function App() {
  ...
  const regions = {
    agu: {
      name: "Aguascalientes",
      description: "Descripción de Aguascalientes",
    },
    bcn: {
      name: "Baja California",
      description: "Descripción de Baja California",
    },

    bcs: {
      name: "Baja California Sur",
      description: "Descripción de Baja California Sur",
    },

    cam: {
      name: "Campeche",
      description: "Descripción de Campeche",
    },
    chp: {
      name: "Chiapas",
      description: "Descripción de Chiapas",
    },
    chh: {
      name: "Chihuahua",
      description: "Descripción de Chihuahua",
    },
    coa: {
      name: "Coahuila",
      description: "Descripción de Coahuila",
    },
    col: {
      name: "Colima",
    ...
    dif: {
      ...
      description: "Descripción de Ciudad de México",
    },
    dur: {
      name: "Durango",
      description: "Descripción de Durango",
    },
    gua: {
      name: "Guanajuato",
      description: "Descripción de Guanajuato",
    },
    gro: {
      name: "Guerrero",
      description: "Descripción de Guerrero",
    },
    hid: {
      name: "Hidalgo",
      description: "Descripción de Hidalgo",
    },
    jal: {
      name: "Jalisco",
      description: "Descripción de Jalisco",
    },
    mex: {
      name: "Estado de México",
      description: "Descripción de Estado de México",
    },
    mic: {
      name: "Michoacán",
      description: "Descripción de Michoacán",
    },
    mor: {
      name: "Morelos",
      description: "Descripción de Morelos",
    },
    nay: {
      name: "Nayarit",
      description: "Descripción de Nayarit",
    },    nel: {
      name: "Nuevo León",
      description: "Descripción de Nuevo León",
    },    oax: {
      name: "Oaxaca",
      description: "Descripción de Oaxaca",
    },    pue: {
      name: "Puebla",
      description: "Descripción de Puebla",
    },    que: {
      name: "Querétaro - 1",
      description: "Descripción de Querétaro - 1",
    },    roo: {
      name: "Quintana Roo",
      description: "Descripción de Quintana Roo",
    },    slp: {
      name: "San Luis Potosí",
      description: "Descripción de San Luis Potosí",
    },    sin: {
      name: "Sinaloa",
      description: "Descripción de Sinaloa",
    },    son: {
      name: "Sonora",
      description: "Descripción de Sonora",
    },    tab: {
      name: "Tabasco",
      description: "Descripción de Tabasco",
    },    tam: {
      name: "Tamaulipas",
      description: "Descripción de Tamaulipas",
    },    tla: {
      name: "Tlaxcala",
      description: "Descripción de Tlaxcala",
    },    ver: {
      name: "Veracruz",
      description: "Descripción de Veracruz",
    },    yuc: {
      name: "Yucatán",
      description: "Descripción de Yucatán",
    },    zac: {
      name: "Zacatecas",
      description: "Descripción de Zacatecas",
    },  
  };
