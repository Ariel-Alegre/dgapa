...
export default function HomeComponent() {
  ...
  // Funciones para manejar el hover sobre los SVGs
  const handleMouseEnter = (title, content) => {
    setCardContent({ title, content }); // Muestra la tarjeta con el título y contenido proporcionados
  };

  const handleMouseLeave = () => {
    setCardContent({ title: '', content: '' }); // Oculta la tarjeta
  };
  useEffect(() => {
    Global();
  }, []);
      ...
      <main class="main">
        ...
        <section id="constructions" class="constructions section">
          <div class="container section-title" data-aos="fade-up">
            ...
            >Escuelas Normales Superiores en México</h2>
            ...
            >
              <Link to="/queretaro">
                <path
                  ...
                  onMouseEnter={() => handleMouseEnter('Path Card', 'This is the content for the path card.')}
                  onMouseLeave={handleMouseLeave}
               ></path>
              </Link>

               {cardContent.title && (
        <div className="card-toolip">
