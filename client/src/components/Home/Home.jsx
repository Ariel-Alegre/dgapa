    ...
    <div className="about-page">
      ...
      <main class="main">
        ...
        <div class="container section-title" data-aos="fade-up">
          <h2>Escuelas Normales Superiores en México</h2>
  ...
  <ul>
    {hoveredRegion.name_school.map((school, index) => (
      <li key={index}>{school}</li>
        ...
        <section id="services" class="services section mobile-province light-background">
            ...
            <div class="row no-gutters">
              <div class="col-12  ">
                <ul>
                  ...
                  <li value="Guanajuato">
                    Guanajuato <Link to="/CampGuanajuatoeche">Ver escuelas</Link>
                  </li>
                  <li value="Guerrero">
                  ...
                  <li value="Estado de México">
                    Estado de México <Link to="/Estado-de-México">Ver escuelas</Link>
                  </li>
                  <li value="Michoacán de Ocampo">
                    Michoacán de Ocampo <Link to="/Michoacán">Ver escuelas</Link>
                  </li>
                  <li value="Morelos">
                  ...
                  <li value="San Luis Potosí">
                    San Luis Potosí <Link to="/San-Luis-Potosí">Ver escuelas</Link>
                  </li>
                  <li value="Sinaloa">
