...
function App() {
  ...
  const aguSchools = allSchool.filter((data) => data.province === "Aguascalientes");
  const bcnSchools = allSchool.filter((data) => data.province === "Baja California");
  const bcsSchools = allSchool.filter((data) => data.province === "Baja California Sur");
  ...
  const difSchools = allSchool.filter((data) => data.province === "Ciudad de México");
  ...
  const mexSchools = allSchool.filter((data) => data.province === "Estado de México");
  ...
  const rooSchools = allSchool.filter((data) => data.province === "Quintana Roo");
  const slpSchools = allSchool.filter((data) => data.province === "San Luis Potosí");
          ...
          <div class="container">
            ...
            <div class="container section-title" data-aos="fade-up">
              ...
              <p>
                ...
                instituciones en la educación nacional. Desde su establecimiento hasta
                su significativo papel en la formación docente, proporcionamos una
                perspectiva detallada y recursos educativos pertinentes.
              </p>
            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  La Escuela Normal Superior Universitaria (ENSU), de
                                  la antigua Facultad de Altos Estudios (FAE),
                                  ...
                                  secundaria. Fue cerrada temporalmente el mismo año;
                                  reabierta en 1925; enseguida de la Facultad de
                                  Filosofía y Letras en 1929 y separada de manera
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  tarde se transformó en Escuela Normal Superior
                                  (ENS), como centro de formación de profesores de
                                  educación secundaria. En un primer momento, se
                                  adscribió al Departamento de Enseñanza Secundaria de
                                  la Dirección General de Segunda Enseñanza.
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  graduados en las escuelas normales urbanas y a los
                                  de las rurales. Ambos profesores los capacitaba para
                                  ejercer la docencia como profesores de Educación
                                  Normal, Secundaria, Técnica o de cualquier grado de
                                  la Educación Superior y graduaba doctores en
                                  Ciencias de la Educación (Artículo 71, Capítulo
                                  XIII).{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  igual validez que los realizados en escuelas
                                  normales superiores y furndar institutos de
                                  mejoramiento profesional para elevar el nivel
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  con los planes de estudio y reglamentos de la
                                  Escuela Normal Superior de la Ciudad de México y en
                                  abril de 1962 por decreto del gobernador se
                                  constituye con personalidad jurídica y patrimonio
                                  propios. (Trujillo, 2014: 28). En 1995 se abrieron
                                  las unidades en Parral y Ciudad Juárez y en 2002 en
                                  Nuevo Casas Grandes. Posteriormente se abrieron las
                                  extensiones de Cuauhtémoc, Creel y Chínipas
                                  (Trujillo, 2014: 32). Se crearon: la Escuela Normal
                                  de Atlacomulco y la Escuela Normal de Tlalnepantla
                                  como instituciones públicas estatales en la
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Sureste “Lic. Benito Juárez”, Oaxaca (cerrada) y la
                                  Escuela Normal Superior Anexa al Instituto “Justo
                                  Sierra”, León, Gto. Ambas escuelas particulares. La
                                  primera fue cerrada y la segunda fue incorprada al
                                  gobierno del Estado.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Morelos y en 1988 posteriormente a Escuela
                                  Particular Normal Superior del Estado (EPNSE)
                                  (Araujo y Estrada, 2009: 43, 49). Las dos primeras
                                  de sostenimiento estatal y la última particular que
                                  pasó a ser de sostenimiento estatal (Araujo y
                                  Estrada, 2009: 43){" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  que imparta enseñanza de Normal Superior en la que
                                  se denominaría “Escuela Normal Superior de
                                  Tamaulipas”.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  57 pasó a ser estatal, la Escuela Normal Superior de
                                  Jalisco y la Escuela Normal Superior de Michoacán.
                                  Las tres instituciones dependientes del gobierno de
                                  los Estados. La Escuela Normal Superior de Michoacán
                                  se transformó en el Instituto Michoacano de Ciencias
                                  de la Educación “José María Morelos”, por Decreto
                                  Gobierno del Estado, del 24 de marzo de 1986. Se
                                  creó la Escuela Normal de Naucalpan, como
                                  institución pública estatal en la formación de
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  A.C., Durango, la Escuela Normal Superior de Durango
                                  y la Escuela Normal Superior “Justo Sierra”, A.C.,
                                  Puebla. Todas escuelas particulares incorporadas a
                                  los gobiernos de los Estados. Surgieron: la Escuela
                                  Normal de Capulhuac, la Escuela Normal de Cuautitlán
                                  Izcalli, la Escuela Normal de Santiago
                                  Tianguistenco, la Escuela Normal de Sultepec, la
                                  Escuela Normal de Tenancingo, la Escuela Normal de
                                  Teotihuacán, la Escuela Normal de Valle de Bravo, la
                                  Escuela Normal No. 2 de Nezahualcóyotl como
                                  instituciones públicas estatales, en la formación de
                                  maestros de secundaria.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  del Estado; la Escuela Normal Superior de Querétaro,
                                  A. C., y la Escuela Normal Superior del Sur de
                                  Tamaulipas A.C, instituciones educativas
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Superior y Especialidades para administrar, dirigir
                                  y supervisar el funcionamiento de la Escuela Normal
                                  ...
                                  Superior de Ecatepec, la Escuela Normal de Amecameca
                                  y la Escuela Normal Santa Ana Zicatecoyan de
                                  sostenimiento estatal (en la formación de maestros
                                  de secundaria) y la Escuela Normal Superior del
                                  Estado de Hidalgo de sostenimiento particular. Las
                                  dos últimas instituciones formadoras fueron
                                  incorporadas a los gobiernos de los Estados. La
                                  Escuela Normal Superior de Chiapas por convenio de
                                  1977 transita del sostenimiento estatal al federal.{" "}
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Escuelas Normales Superiores Estatales. (Gámez,
                                  1990: 14). Surgió la Escuela Normal Superior de
                                  Ciudad Madero A.C., Tamaulipas, como institución
                                  formadora particular.{" "}
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Cursos Intensivos en Veracruz, institución educativa
                                  federal, como parte del proceso de regionalización
                                  de la formación docente de maestros, con tres
                                  departamentos de Control escolar, Titulación e
                                  Investigación, Área académica y Planeación
                                  Educativa.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  ofrecer cursos intensivos a estudiantes procedentes
                                  de los estados de Guerrero, Jalisco, Colima,
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Benito Juárez”, (EPNSBJ), Morelos, como iniciativa
                                  de la delegación XIX del SNTE, "resultado del
                                  conflicto de intereses al interior de la propia
                                  delegación, que llevó a la fractura del profesorado
                                  que laboraba en la Escuela Particular Normal
                                  Superior del Estado (EPNSE) (González, Arredondo,
                                  Espinosa, 2009: 145){" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Dr. Manuel Suárez Trujillo como institución
                                  formadora pública estatal que ofreció la
                                  Licenciatura en Educación Media en modalidad
                                  abierta. En 1996 se crearon subsedes en Tuxpan, Poza
                                  Rica, Córdoba, Minatitlán, Pánuco, San Andrés
                                  ...
                                  Xalapa, mismas que fueron cerradas en el 2011 y 2012
                                  respectivamente. Además, surgió el Instituto
                                  Superior de Educación Normal del Estado de Colima
                                  "Profr. Gregorio Torres Quintero", antes denominado
                                  Escuela Normal de Maestros Profr. Gregorio Torres
                                  Quintero, como instituto público del gobierno
                                  estatal y la Escuela Normal Superior "Prof. Salomón
                                  Barrancos Aguilar" del Instituto Campechano como
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  institución formadora pública de carácter estatal y
                                  la Escuela Normal "Carrillo Cárdenas", institución
                                  privada.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  del Magisterio Potosino. La primera como extensión
                                  de la Escuela Normal Superior, plantel Hermosillo;
                                  la segunda como institución formadora particular; la
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  la Escuela Normal Superior del Istmo de Tehuantepec
                                  de Oaxaca como instituciones formadoras
                                  particulares.{" "}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  Normal General Lázaro Cárdenas del Río (IESEN), como
                            ...
                            <div class="card border-0 shadow">
                              ...
                              <div class="card-body p-xl-4">
                                ...
                                <p class="card-text m-0">
                                  ...
                                  formadora pública federal. En 2010 2010 el ejecutivo
                                  del estado donó un terreno para la construcción de
                                  la escuela, en 2015 se construyeron aulas y módulos
                                  y en 2016 se inauguraron las instalaciones.{" "}
                                </p>
                              </div>
                            </div>
                          </div>
