...
function App() {
  ...
  const toggleMenu = () => {
    setMenuOpen(!menuOpen); // Cambiar el estado
  };
  const toggleMenuClose = () => {
    setMenuOpen(false); // Cambiar el estado
  };
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [pathname]);
  ...
  const handleMouseEnter = (e, province) => {
    ...
    console.log("Escuelas encontradas:", provinceSchools);

    setHoveredRegion({
      id: province,
      name: province,
      totalSchool: provinceSchools.length,
  ...
  const handleOpen = (province) => {
    ...
    if (provinceSchools.length > 0) {
      ...
      console.warn("No se encontraron escuelas para la provincia:", province);
  ...
  const alumnos =
    detailsSchool && detailsSchool.alumnos
      ? detailsSchool.alumnos.reduce(
          (total, data) => total + Number(data.cantidadAlumnos),
          0
        )
      : 0;

  const alumnas =
    detailsSchool && detailsSchool.alumnas
      ? detailsSchool.alumnas.reduce(
          (total, data) => total + Number(data.cantidadAlumnas),
          0
        )
      : 0;

  const total = alumnos + alumnas;

  const porcentageAlumnos = total > 0 ? (alumnos / total) * 100 : 0;

  const porcentageAlumnas = total > 0 ? (alumnas / total) * 100 : 0;

  const teacher =
    detailsSchool && detailsSchool.profesores
      ? detailsSchool.profesores.reduce((total, row) => {
          // Verifica que row.textProfeactuales sea un arreglo y cuenta su longitud
          return (
            total +
            (Array.isArray(row.textProfeactuales)
              ? row.textProfeactuales.length
              : 0)
          );
        }, 0)
      : 0;

  const teacherDoctorProfessor =
    detailsSchool && detailsSchool.profesoresConDoctorados
      ? detailsSchool.profesoresConDoctorados.reduce((total, row) => {
          // Verifica que row.textProfeactuales sea un arreglo y cuenta su longitud
          return (
            total +
            (Array.isArray(row.textProfeDoctorado)
              ? row.textProfeDoctorado.length
              : 0)
          );
        }, 0)
      : 0;

  const teacherMasterProfessor =
    detailsSchool && detailsSchool.profesoresMaestrias
      ? detailsSchool.profesoresMaestrias.reduce((total, row) => {
          // Verifica que row.textProfeactuales sea un arreglo y cuenta su longitud
          return (
            total +
            (Array.isArray(row.textProfeMaestria)
              ? row.textProfeMaestria.length
              : 0)
          );
        }, 0)
      : 0;

  const candidatDoctor =
    detailsSchool && Array.isArray(detailsSchool.doctoresCandidatos)
      ? detailsSchool.doctoresCandidatos.length
      : 0;

  const candidatJubilados =
        ...
        <section id="constructions" class="constructions section">
          <div class={viewInfo ? "container data-map" : "container"}>
            <div class="row gy-4  map-container">
              ...
              >
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Aguascalientes")}
                  onClick={(e) => handleOpen(e, "Aguascalientes")}
                  onMouseLeave={handleMouseLeave}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Baja California")}
                  onClick={() => handleOpen("Baja California")}
                  onMouseLeave={handleMouseLeave}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) =>
                    handleMouseEnter(e, "Baja California Sur")
                  }
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Baja California Sur")}
                ></path>
                ...
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Campeche")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Campeche")}
                ></path>
                ...
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Chiapas")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Chiapas")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Chihuahua")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Chihuahua")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Coahuila")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Coahuila")}
                ></path>
                ...
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Colima")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Colima")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Ciudad de México")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Ciudad de México")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Durango")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Durango")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Guanajuato")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Guanajuato")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Guerrero")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Guerrero")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Hidalgo")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Hidalgo")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Jalisco")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Jalisco")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Estado de México")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Estado de México")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Michoacán")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Michoacán")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Morelos")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Morelos")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Nayarit")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Nayarit")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Nuevo León")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Nuevo León")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Oaxaca")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Oaxaca")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Puebla")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Puebla")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Querétaro")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Querétaro")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Quintana Roo")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Quintana Roo")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "San Luis Potosí")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("San Luis Potosí")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Sinaloa")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Sinaloa")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Sonora")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Sonora")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Tabasco")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Tabasco")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Tamaulipas")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Tamaulipas")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Tlaxcala")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Tlaxcala")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Veracruz")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Veracruz")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Yucatán")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Yucatán")}
                ></path>
                <path
                  ...
                  onMouseEnter={(e) => handleMouseEnter(e, "Zacatecas")}
                  onMouseLeave={handleMouseLeave}
                  onClick={() => handleOpen("Zacatecas")}
                ></path>
              </svg>
              {hoveredRegion && (
                <Box
                ...
                >
                  ...
                  <p>
                    ...
                    {hoveredRegion && hoveredRegion.totalSchool}
                  </p>
                  {hoveredRegion &&
              ...
              >
                <Fade in={open}>
                  <Box sx={style}>
                    <h4>Escuelas de {modalRegion && modalRegion.name}</h4>
                    <p>
                      Cantidad de escuelas:{" "}
                      {modalRegion && modalRegion.totalSchool}
                    </p>
                    {modalRegion &&
                      modalRegion.schools.map((data, index) => (
                        <ul>
                          <li key={index}>
                            {data.name}{" "}
                            <span
                              onClick={() => handleViewInfo(data.id)}
                              className="view-data"
                            >
                              Ver datos
                            </span>
            ...
            <div>
              {viewInfo && (
                <div>
                  <h1>{detailsSchool && detailsSchool.name}</h1>
                  <Link
                    to={`/escuelas-detalles/${detailsSchool.id}`}
                    style={{ margin: "auto" }}
                  >
                    Ver mas detalles
                  </Link>
                  ...
                  <div className="container-students-doctors">
                    <div className="data-students">
                      <div className="total-students">Total: {total}</div>
                        ...
                        <div className="students-chart">
                          <div className="circle">
                            ...
                            <div
                              ...
                              style={{
                                background: `conic-gradient(#ff99cc 0 ${porcentageAlumnas}%, #99ccff ${porcentageAlumnos}% 100%)`,
                              }}
                            ></div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          Alumnas: {Number(porcentageAlumnas).toFixed(2)}%
                        </div>
                        <div>
                          Alumnos: {Number(porcentageAlumnos).toFixed(2)}%
                        </div>
                      </div>
                    </div>
                    <div>
                      <div>
                        ...
                        <div>
                          ...
                          <div className="teacher-current">
                            <div>
                              Doctorados: {teacherDoctorProfessor}
                              <input
                                type="range"
                                value={teacherDoctorProfessor}
                                name=""
                                id=""
                              />
                            </div>
                          ...
                          <div className="teacher-current">
                            <div>
                              Maestria: {teacherMasterProfessor}
                              <input
                                type="range"
                                value={teacherMasterProfessor}
                                name=""
                                id=""
                              />
                            </div>
                    ...
                    <div>
                      <div>
                        ...
                        <div>
                          <div className="teacher-current">
                            <div>
                              Candidatos: {candidatDoctor}
                              <input
                                type="range"
                                value={candidatDoctor}
                                name=""
                                id=""
                              />
                            </div>
                          ...
                          <div className="teacher-current">
                            <div>
                              Jubilados: {candidatJubilados}
                              <input
                                type="range"
                                value={candidatJubilados}
                                name=""
                                id=""
                              />
                            </div>
