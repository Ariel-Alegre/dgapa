...
export default function NuevoLeón() {
  ...
  const durangoSchools = allSchool.filter((data) => data.province === "Nuevo León");
          ...
          <div className="container gallery-card">
            {durangoSchools.length > 0 ? (
              ...
              <Typography variant="h6" sx={{ textAlign: "center", marginTop: 2 }}>
                No hay escuelas registradas en Nuevo León.
              </Typography>
            )}
          </div>
        </section>
