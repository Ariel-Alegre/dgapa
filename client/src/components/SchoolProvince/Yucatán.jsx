...
export default function Yucatán() {
  ...
  const durangoSchools = allSchool.filter((data) => data.province === "Yucatán");
          ...
          <div className="container gallery-card">
            {durangoSchools.length > 0 ? (
              ...
              <Typography variant="h6" sx={{ textAlign: "center", marginTop: 2 }}>
                No hay escuelas registradas en Yucatán.
              </Typography>
            )}
          </div>
        </section>
