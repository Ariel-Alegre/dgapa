...
export default function Michoacán() {
  ...
  const durangoSchools = allSchool.filter((data) => data.province === "Michoacán");
          ...
          <div className="container gallery-card">
            {durangoSchools.length > 0 ? (
              ...
              <Typography variant="h6" sx={{ textAlign: "center", marginTop: 2 }}>
                No hay escuelas registradas en Michoacán.
              </Typography>
            )}
          </div>
        </section>
