...
export default function EstadodeMéxico() {
  ...
  const durangoSchools = allSchool.filter((data) => data.province === "Estado de México");
        ...
        <section id="about" className="about section" data-aos="fade-up">
          <div className="page-schools dark-background">
            <div
              ...
              data-aos-delay="100"
            >
              <h1>Escuelas de Estado de México</h1>
            </div>
          </div>
          <div className="container gallery-card">
            {durangoSchools.length > 0 ? (
              ...
              <Typography variant="h6" sx={{ textAlign: "center", marginTop: 2 }}>
                No hay escuelas registradas en Estado de México.
              </Typography>
            )}
          </div>
        </section>
